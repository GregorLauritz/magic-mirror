...
describe('RangeParameterValidator', () => {
  describe('Query Parameter Validation', () => {
    ...
    it('should pass validation for value at minimum', () =>
      new Promise<void>((done) => {
        const validator = new RangeParameterValidator('count', { min: 1, max: 100 }, EParamType.query, true);
        const req = {
          query: { count: '1' },
    ...
    it('should pass validation for value at maximum', () =>
      new Promise<void>((done) => {
        const validator = new RangeParameterValidator('count', { min: 1, max: 100 }, EParamType.query, true);
        const req = {
          query: { count: '100' },
    ...
    it('should fail validation for negative values when not in range', () =>
      new Promise<void>((done) => {
        const validator = new RangeParameterValidator('count', { min: 1, max: 100 }, EParamType.query, true);
        const req = {
          query: { count: '-5' },
  ...
  describe('Required Parameter Handling', () => {
    ...
    it('should pass validation when optional parameter is missing', () =>
      new Promise<void>((done) => {
  ...
  describe('Route Parameter Validation', () => {
    ...
    it('should fail for route parameter out of range', () =>
      new Promise<void>((done) => {
        const validator = new RangeParameterValidator('id', { min: 1, max: 1000 }, EParamType.request, true);
        const req = {
          params: { id: '2000' },
