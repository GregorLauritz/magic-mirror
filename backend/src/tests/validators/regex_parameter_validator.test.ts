...
describe('RegexParameterValidator', () => {
  describe('Query Parameter Validation', () => {
    ...
    it('should validate country code pattern', () =>
      new Promise<void>((done) => {
  ...
  describe('Route Parameter Validation', () => {
    ...
    it('should fail for route parameter not matching pattern', () =>
      new Promise<void>((done) => {
        const validator = new RegexParameterValidator('icon', /^\d{2}[dn]$/, EParamType.request, true);
        const req = {
          params: { icon: '00x' },
  ...
  describe('Common Pattern Validations', () => {
    ...
    it('should fail for special characters when not allowed', () =>
      new Promise<void>((done) => {
        const alphanumericRegex = /^[a-zA-Z0-9]+$/;
        const validator = new RegexParameterValidator('code', alphanumericRegex, EParamType.query, true);
        const req = {
  ...
  describe('Edge Cases', () => {
    it('should handle empty string when pattern requires content', () =>
      new Promise<void>((done) => {
        const nonEmptyRegex = /^.+$/;
    ...
    it('should validate case-sensitive patterns', () =>
      new Promise<void>((done) => {
    ...
    it('should fail case-sensitive patterns with wrong case', () =>
      new Promise<void>((done) => {
        const uppercaseRegex = /^[A-Z]+$/;
        const validator = new RegexParameterValidator('code', uppercaseRegex, EParamType.query, true);
        const req = {
