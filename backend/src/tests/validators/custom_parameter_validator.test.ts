...
describe('CustomParameterValidator', () => {
  describe('Query Parameter Validation', () => {
    ...
    it('should validate with async function', () => {
      return new Promise<void>((done) => {
    ...
    it('should fail validation with async function', () => {
      return new Promise<void>((done) => {
        const validationFunc = async (param: string) => {
          return new Promise<boolean>((resolve) => {
  ...
  describe('Route Parameter Validation', () => {
    ...
    it('should fail for invalid route parameter', () => {
      return new Promise<void>((done) => {
  ...
  describe('Complex Validation Logic', () => {
    it('should validate with complex business logic', () => {
      return new Promise<void>((done) => {
        const validationFunc = async (param: string) => {
    ...
    it('should validate with external API check simulation', () => {
      return new Promise<void>((done) => {
        const validationFunc = async (param: string) => {
    ...
    it('should fail validation with multi-condition check', () => {
      return new Promise<void>((done) => {
        const validationFunc = async (param: string) => {
